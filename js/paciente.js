...
async function carregarPacientes() {
  try {
    ...
    const response = await fetch("https://ec2-3-147-64-107.us-east-2.compute.amazonaws.com:3000/paciente/consultar");
...
async function realizarCadastro(evento) {
  ...
  try {
    ...
    const httpResponse = await fetch(`https://ec2-3-147-64-107.us-east-2.compute.amazonaws.com:3000/paciente/inserir?nome=${nome}&cpf=${cpf}&sexo=${sexo}&data_nascimento=${data_nascimento}`, {
      method: "POST",
...
async function excluirUsuario(botao) {
  ...
  try {
    ...
    const response = await fetch(
      `https://ec2-3-147-64-107.us-east-2.compute.amazonaws.com:3000/paciente/excluir/${id}`,
      conteudoHttp
    );
